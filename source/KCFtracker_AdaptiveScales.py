...
# Implementation of KCF tracker with adaptive scales.
# Refer to the paper "A Scale Adaptive Kernel Correlation Filter Tracker with Feature Integration"
...
class KCFTracker_AdaptiveScales(object):
    """
    ...
    def response_win_ave_max(self, response, cx, cy, winsize):
        ...
        psr = (res_win_max-sidelob_mean)/np.sqrt(sidelob_var)
