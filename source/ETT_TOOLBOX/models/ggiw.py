...
class GgiwTracker(SingleTargetTracker):
    ...
    def __init__(self, **kwargs):
        ...
        self._dt_ggiw = np.dtype([('m', 'f8', self._sd),                 #4x1
                                  ('c', 'f8', (self._s, self._s)),       #2x2
                                  ('c_v', 'f8', (self._sd, self._sd)),   #4x4
                                  ('v', 'f8', (self._d, self._d)),       #2x2
                                  ('nu', 'f8'),                          #scalar
                                  ('alpha', 'f8'),                       #scalar
                                  ('beta', 'f8'),                        #scalar
                                  ])
    ...
    def correct(self, z):
        ...
        self._ggiw_post['nu'][self._uc] = 0.2*self._ggiw_prior['nu'][self._uc] + 0.8*z_cd
